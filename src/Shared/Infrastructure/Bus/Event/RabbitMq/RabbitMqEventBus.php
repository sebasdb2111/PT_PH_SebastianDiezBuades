...
namespace PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\RabbitMq;

use AMQPException;
use PruebaTecnicaPh\Shared\Domain\Bus\Event\DomainEvent;
use PruebaTecnicaPh\Shared\Domain\Bus\Event\EventBus;
use PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\DomainEventJsonSerializer;
use PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineEventBus;
