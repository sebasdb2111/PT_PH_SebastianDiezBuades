...
use PruebaTecnicaPh\Backoffice\Auth\Application\Authenticate\AuthenticateUserCommand;
use PruebaTecnicaPh\Backoffice\Auth\Domain\InvalidAuthCredentials;
use PruebaTecnicaPh\Backoffice\Auth\Domain\InvalidAuthUsername;
...
final class BasicHttpAuthMiddleware
{
    ...
    {
        $event->setResponse(
            new Response('', Response::HTTP_UNAUTHORIZED, ['WWW-Authenticate' => 'Basic realm="PruebaTecnicaPh"'])
        );
    }
}
