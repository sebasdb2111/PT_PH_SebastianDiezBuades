...
use PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqDomainEventsConsumer;
use PruebaTecnicaPh\Shared\Infrastructure\Doctrine\DatabaseConnections;
...
{
    protected static $defaultName = 'pruebatecnicaph:domain-events:rabbitmq:consume';
    private $consumer;
    private $connections;
    private $locator;
