...
use PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqConfigurer;
...
{
    protected static $defaultName = 'pruebatecnicaph:domain-events:rabbitmq:configure';
    private $configurer;
