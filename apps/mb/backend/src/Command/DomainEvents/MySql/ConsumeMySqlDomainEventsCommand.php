...
namespace PruebaTecnicaPh\Apps\Mb\Backend\Command\DomainEvents\MySql;
...
use PruebaTecnicaPh\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineDomainEventsConsumer;
...
{
    protected static $defaultName = 'pruebatecnicaph:domain-events:mysql:consume';
    private $consumer;
